// src/routes/index.js — thêm 2 route verify email
...
import {
    isAuthorized, isManager, isStaffOrManager, isDriver,
} from "../middlewares/authMiddleware.js";

import {
    validateRegister, validateLogin, validateForgotPassword,
    validateResetPassword, validateSocialLogin,
    validateCreateReservation, validateCheckIn, validateCheckOut,
} from "../utilities/authValidation.js";

const router = express.Router();

router.get("/health", (req, res) => res.json({ success: true, message: "API is working" }));
