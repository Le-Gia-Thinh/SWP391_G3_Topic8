...
const Modal = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      />
      <div
        className={`relative z-10 w-full ${maxWidth} transform rounded-2xl bg-white dark:bg-slate-800 shadow-2xl transition-all animate-in fade-in zoom-in-95 duration-200`}
      >
        {(title || showClose) && (
