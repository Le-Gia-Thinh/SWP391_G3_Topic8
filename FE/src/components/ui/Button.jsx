...
const Button = ({
  ...
  const variants = {
    ...
    secondary: 'bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-slate-700 hover:bg-gray-50 dark:bg-slate-900/50',
