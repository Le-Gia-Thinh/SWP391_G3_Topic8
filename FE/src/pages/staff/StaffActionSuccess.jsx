...
const StaffActionSuccess = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 pb-24 animate-in fade-in">
      {/* Breadcrumb */}
      ...
      <div className="flex gap-6 flex-1 flex-col xl:flex-row">
        ...
        <div className="flex-2 space-y-6">
          {/* Status banner */}
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-green-200 p-6 flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {isBooking && (
                <div className="flex items-center gap-3 mt-4">
                  <span className="text-xs font-semibold px-3 py-1.5 bg-slate-100 text-slate-600 rounded-md border border-slate-100 uppercase">
              ...
              {isCheckOut && (
                <div className="flex gap-3 mt-4">
                  <button className="px-4 py-2 border border-slate-300 rounded-xl text-sm font-semibold text-slate-700 hover:bg-slate-50 flex items-center gap-2">
                    <Printer size={16} /> {t('staff.actionSuccess.printReceipt')}
                  </button>
                  <button
                    onClick={() => navigate('/staff/dashboard')}
                    className="px-4 py-2 bg-blue-600 text-white shadow-md shadow-blue-500/20 hover:shadow-blue-500/40 rounded-xl text-sm font-bold hover:bg-blue-700 flex items-center gap-2"
                  >
          ...
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50 p-6">
            ...
            {isCheckOut && checkoutData && (
              <div className="bg-blue-50 border border-blue-100 rounded-3xl p-5 mt-5 flex justify-between items-center">
            ...
            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50 p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="text-sm font-semibold text-red-500 hover:text-red-700 flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-xl border border-red-100"
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                {[
                  ...
                  <div key={label}>
                    <p className="text-xs text-slate-500 font-semibold mb-1 uppercase">{label}</p>
        ...
        <div className="flex-1 space-y-6">
          {isBooking && (
            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50 p-6 flex flex-col items-center text-center">
              ...
              <div className="flex gap-3 w-full">
                <button
                  onClick={() => navigate('/staff/dashboard')}
                  className="flex-2 py-3 bg-blue-600 text-white shadow-md shadow-blue-500/20 hover:shadow-blue-500/40 font-bold rounded-3xl shadow-md hover:bg-blue-700 flex justify-center items-center gap-2"
                >
          ...
          {/* Slot status change */}
          <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50 p-6 text-center">
            <h3 className="text-sm font-bold text-slate-600 mb-4 uppercase">
              {t('staff.actionSuccess.slotUpdateTitle')}
            </h3>
            <div className="bg-blue-50 border border-blue-100 rounded-3xl p-4 mb-4">
            ...
            <div className="flex items-center justify-center gap-4 text-sm font-bold">
              <span className={`px-4 py-2 rounded-xl border ${isCheckOut
            ...
            <p className="text-xs text-green-600 bg-green-50 px-3 py-2 mt-4 rounded-xl border border-green-100 flex items-center justify-center gap-1">
            ...
            <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50 p-6">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  <div className="w-6 h-6 rounded-full bg-blue-600 text-white shadow-md shadow-blue-500/20 hover:shadow-blue-500/40 flex items-center justify-center font-bold text-xs shrink-0">1</div>
                  <p
                ...
                <div className="flex gap-3">
                  <div className="w-6 h-6 rounded-full bg-blue-600 text-white shadow-md shadow-blue-500/20 hover:shadow-blue-500/40 flex items-center justify-center font-bold text-xs shrink-0">2</div>
                  <p className="text-sm text-slate-600">{t('staff.actionSuccess.nextStep2')}</p>
                </div>
              </div>
            </div>
          )}
      ...
      {/* Bottom bar */}
      <div className="fixed bottom-0 left-0 md:left-64 right-0 bg-white/80 backdrop-blur-xl border-t border-slate-100 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-20">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={() => navigate('/staff/dashboard')}
              className="px-6 py-2.5 rounded-3xl border border-slate-300 text-slate-700 font-bold hover:bg-slate-50"
            >
              {t('staff.actionSuccess.goToDashboard')}
            </button>
            <button
              onClick={() => navigate(isCheckOut ? '/staff/checkout' : '/staff/checkin')}
              className="px-6 py-2.5 rounded-3xl bg-blue-600 text-white shadow-md shadow-blue-500/20 hover:shadow-blue-500/40 font-bold hover:bg-blue-700"
            >
