  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-900 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900">
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-blue-900/90 via-slate-900/60 to-transparent" />
        
        <div className="relative z-10 p-16 flex flex-col justify-end h-full text-white">
          <div className="w-16 h-16 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 flex items-center justify-center mb-6 shadow-2xl">
            <ShieldCheck size={32} className="text-blue-400 drop-shadow-md" />
          </div>
          <h2 className="text-5xl font-black tracking-tight mb-4 leading-tight drop-shadow-lg bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-300">
            Hệ Thống Đỗ Xe <br/> Thông Minh
          </h2>
      ...
      <div className="w-full lg:w-1/2 flex flex-col relative min-h-screen">
        ...
        <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-blue-400/20 rounded-full blur-[120px] mix-blend-multiply opacity-60 dark:opacity-20 pointer-events-none animate-[pulse_8s_ease-in-out_infinite]" />
        
        {/* Top Navigation / Header */}
        <div className="flex justify-between items-center w-full p-6 sm:p-8 z-20">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 bg-white/60 dark:bg-slate-800/50 backdrop-blur-xl px-4 py-2 rounded-xl border border-slate-200/60 dark:border-slate-700/60 transition-all hover:shadow-md hover:-translate-x-1"
          >
            <ArrowLeft size={16} />
            <span className="hidden sm:inline">{t('auth.login.backToHome', 'Quay lại')}</span>
          </Link>

          <button
            type="button"
            onClick={toggleLanguage}
            className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 bg-white/60 dark:bg-slate-800/50 backdrop-blur-xl px-4 py-2 rounded-xl border border-slate-200/60 dark:border-slate-700/60 transition-all hover:shadow-md hover:scale-105"
          >
            <Globe size={16} />
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-8 z-10">
          <div className="w-full max-w-[440px] bg-white/80 dark:bg-slate-800/80 backdrop-blur-3xl rounded-[2.5rem] shadow-[0_8px_40px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_40px_rgb(0,0,0,0.3)] border border-white/50 dark:border-slate-700/50 p-8 sm:p-10 transition-all duration-300">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3.5 rounded-2xl border-2 text-sm font-bold outline-none transition-all shadow-sm
                      bg-white/50 dark:bg-slate-900/50 dark:text-white
                      focus:bg-white dark:focus:bg-slate-800 focus:ring-4 focus:ring-blue-500/10 dark:focus:ring-blue-400/10
                      ${errors.account ? 'border-red-400 focus:border-red-500 bg-red-50/50' : 'border-slate-200 dark:border-slate-700 focus:border-blue-500 hover:border-slate-300 dark:hover:border-slate-600'}`}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-11 py-3.5 rounded-2xl border-2 text-sm font-bold outline-none transition-all shadow-sm
                      bg-white/50 dark:bg-slate-900/50 dark:text-white
                      focus:bg-white dark:focus:bg-slate-800 focus:ring-4 focus:ring-blue-500/10 dark:focus:ring-blue-400/10
                      ${errors.password ? 'border-red-400 focus:border-red-500 bg-red-50/50' : 'border-slate-200 dark:border-slate-700 focus:border-blue-500 hover:border-slate-300 dark:hover:border-slate-600'}`}
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    type="checkbox"
                    {...register('remember')}
                    className="w-4 h-4 rounded border-slate-300 dark:border-slate-600 text-blue-600 focus:ring-blue-500 transition-colors dark:bg-slate-900"
                  />
                  <span className="text-sm font-bold text-slate-500 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-300 transition-colors">{t('auth.login.rememberMe')}</span>
                </label>
                <Link to="/forgot-password" className="text-sm font-black text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
              ...
              <button
                ...
                className="w-full py-4 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-sm font-black tracking-wide rounded-2xl transition-all shadow-[0_8px_20px_rgb(37,99,235,0.2)] hover:shadow-[0_12px_30px_rgb(37,99,235,0.3)] hover:-translate-y-0.5 flex items-center justify-center gap-2 group relative overflow-hidden"
              >
            ...
            <div className="my-8 flex items-center gap-4">
              ...
              <span className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">{t('common.or')}</span>
              <div className="flex-1 h-px bg-slate-200 dark:bg-slate-700" />
            </div>
            ...
            <div className="mt-8 text-center bg-slate-50/80 dark:bg-slate-900/50 py-4 rounded-xl border border-slate-100 dark:border-slate-700/80">
              <p className="text-sm font-bold text-slate-500 dark:text-slate-400">
                ...
                <Link to="/register" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-black transition-colors ml-1">
