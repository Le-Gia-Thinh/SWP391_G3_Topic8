...
const DriverHelp = () => {
  ...
  return (
    <div className="animate-in fade-in duration-500 space-y-6">
      <section>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Trợ giúp & Chính sách</h1>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Các thông tin hỗ trợ và quy định của hệ thống.</p>
      </section>
            ...
            <div className="space-y-8 animate-in fade-in">
              <section className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="rounded-2xl border border-blue-100 bg-blue-50/30 p-6 flex flex-col items-center text-center transition hover:bg-blue-50/50">
                  ...
                  <h3 className="font-bold text-gray-900 dark:text-white mb-1">Hotline CSKH</h3>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">Hỗ trợ khẩn cấp 24/7</p>
                ...
                <div className="rounded-2xl border border-indigo-100 bg-indigo-50/30 p-6 flex flex-col items-center text-center transition hover:bg-indigo-50/50">
                  ...
                  <h3 className="font-bold text-gray-900 dark:text-white mb-1">Email hỗ trợ</h3>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">Phản hồi trong vòng 24h</p>
                ...
                <div className="rounded-2xl border border-emerald-100 bg-emerald-50/30 p-6 flex flex-col items-center text-center transition hover:bg-emerald-50/50">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">Trò chuyện với nhân viên</p>
                  <button                      onClick={() => {
              ...
              <section>
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-bold text-gray-900 dark:text-white">Câu hỏi thường gặp (FAQ)</h2>
                </div>
          ...
          {activeTab === 'terms' && (
            <div className="space-y-6 animate-in fade-in">
              <div className="flex items-center gap-3 border-b border-gray-100 dark:border-slate-700/50 pb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Điều khoản dịch vụ</h2>
              </div>
          ...
          {activeTab === 'privacy' && (
            <div className="space-y-6 animate-in fade-in">
              <div className="flex items-center gap-3 border-b border-gray-100 dark:border-slate-700/50 pb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Chính sách bảo mật</h2>
              </div>
